...
from beetmoverscript.gcloud import cleanup_gcloud, import_artifacts, push_to_releases_gcs, setup_gcloud, upload_to_gcs
...
def main(config_path=None):
    ...
    default_config = {
        ...
        "import_artifacts_schema_file": os.path.join(data_dir, "import_artifacts_beetmover_task_schema.json"),
    }
